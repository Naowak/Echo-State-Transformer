...
def _generate_train_test_samples(n_train, n_valid, n_test, generate_one_sample):
    """
...
def generate_discrete_postcasting(n_train=1000, n_valid=200, n_test=200, sequence_length=1000, delay=10, n_symbols=8):
    ...
    Args:
    - n_train (int): nombre d'échantillons d'entraînement
    - n_valid (int): nombre d'échantillons de validation
    - n_test (int): nombre d'échantillons de test
    ...
    Return:
    - data (dict): dictionnaire contenant les ensembles d'entraînement, de validation et de test ainsi que
    leurs timesteps de prédiction respectifs.
    """
    ...
    return _generate_train_test_samples(n_train, n_valid, n_test, generate_one_sample)




def generate_continue_postcasting(n_train=1000, n_valid=200, n_test=200, sequence_length=1000, delay=10):
    """
    [Multi sequence]
    Génère une tâche de copie : le modèle doit reproduire la séquence d'entrée 
...
def generate_sin_forecasting(sequence_length=1000, forecast_length=1, training_ratio=0.8, validation_ratio=0.1, testing_ratio=0.1):
    """
    [Unique sequence]
    ...
    - validation_ratio (float): proportion de la séquence utilisée pour la validation
    - testing_ratio (float): proportion de la séquence utilisée pour le test
...
def generate_chaotic_forecasting(sequence_length=1000, forecast_length=1, training_ratio=0.8, validation_ratio=0.1, testing_ratio=0.1):
    """
    [Unique sequence]
    ...
    - validation_ratio (float): proportion de sample utilisée pour la validation
    - testing_ratio (float): proportion de sample utilisée pour le test
...
def generate_continue_pattern_completion(n_train=1000, n_valid=200, n_test=200, sequence_length=100, base_length=5, mask_ratio=0.2):
    """
    [Multi sequence]
    Le modèle doit identifier et compléter des motifs répétitifs.
...
def generate_copy_task(n_train=1000, n_valid=200, n_test=200, sequence_length=100, delay=10, n_symbols=8):
    """
    [Multi sequence]
...
def generate_selective_copy_task(n_train=1000, n_valid=200, n_test=200, sequence_length=100, delay=2, n_markers=2, n_symbols=8):
    """
    [Multi sequence]
...
def generate_mnist_classification(n_train=1000, n_valid=200, n_test=200, path=None, cache_dir=None):
    """
    [Multi sequence]
    ...
    - cache_dir (str): chemin vers le dossier de cache huggingface, si None, le cache est utilisé par défaut
